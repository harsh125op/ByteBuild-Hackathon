          ...
          <div className="space-y-4">
            {paginatedTasks.map((task) => (
              ...
              >
                ...
                <div className="mb-3 grid grid-cols-3 gap-2 text-sm text-gray-600">
                  <div className="relative flex items-center">
                    ...
                    {hoveredWasteType === task.wasteType && (
                      <div className="absolute left-0 top-full z-10 mt-1 rounded bg-gray-800 p-2 text-xs text-white shadow-lg">
                        {task.wasteType}
                      </div>
                    )}
                  </div>
      ...
      {selectedTask && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white p-6">
            <h3 className="mb-4 text-xl font-semibold">Verify Collection</h3>
            ...
            >
              {verificationStatus === "verifying" ? (
                <>
                  <Loader className="-ml-1 mr-3 h-5 w-5 animate-spin" />
                  Verifying...
                </>
              ) : (
                "Verify Collection"
